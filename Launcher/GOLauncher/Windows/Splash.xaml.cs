    ...
    public partial class Splash : Window{
        ...
        public Splash(){
            ...
            if(GetLauncherMD5() != getData){
                splashText.Text = "Atualizando Launcher ";
                LauncherUpdating();
            }
            else{
                splashText.Text = "Verificando arquivos ";
        ...
        private async void LauncherUpdating(){
            ...
            using (var client = new WebClient()){
                ...
                client.DownloadFileAsync(new Uri(status.launcherURL + "/Update/launcher.dll"), "launcher.dll");
                var n = DateTime.Now;
                while(output == null){
                    await Task.Delay(1);
                }
        ...
        private void RunCMD(){
            ...
            myProcess.StartInfo.Arguments = "/C launcher.bat";
