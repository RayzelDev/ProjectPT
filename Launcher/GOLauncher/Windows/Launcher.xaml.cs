...
namespace GCLauncher{
    public partial class Launcher : Window{
        ...
        private void LauncherInt(){
            string launcherMaintenance = launcherInfo.GetFileString(1);
            if(launcherMaintenance == "true"){
                serverText.Text = "Manutenção";
                serverText.Foreground = new SolidColorBrush(Colors.Orange);
            }
            else{
                serverText.Text = "Online";
                serverText.Foreground = new SolidColorBrush(Colors.LightGreen);
            }
        ...
        private void ClickLauncher(object sender, RoutedEventArgs e){
            ...
            switch(content){
                ...
                case    "ldb": Process.Start(GetDefaultBrowserPath(), "https://discord.gg/gj28M4Kd3R"); break;
                case    "lfb":   Process.Start(GetDefaultBrowserPath(), "https://discord.gg/gj28M4Kd3R"); break;
                case    "lsb":          Process.Start(GetDefaultBrowserPath(), "https://neverlandpt.com/"); break;
            }
        }
