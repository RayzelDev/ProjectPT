...
//	cnt = 38;
	...
	sField[cnt].SetName("Ocean\\Ocean.ASE", "Ocean");
	sField[cnt].State = FIELD_STATE_RUIN;
	sField[cnt].BackImageCode[0] = FIELD_BACKIMAGE_RUIN2;
	sField[cnt].BackImageCode[1] = FIELD_BACKIMAGE_GLOWRUIN2;
	sField[cnt].BackImageCode[2] = FIELD_BACKIMAGE_NIGHTRUIN2;
	sField[cnt].ServerCode = PLAY_SERVER_CODE_EXTEND;
	sField[cnt].BackMusicCode = BGM_CODE_CUSTOM;
	sField[cnt].AddStageObject("Ocean\\Ocean_ani1.ASE");
	sField[cnt].AddStageObject("Ocean\\Ocean_ani2.ASE");
	sField[cnt].AddStageObject("Ocean\\Ocean_ani3.ASE");
	sField[cnt].AddStageObject("Ocean\\Ocean_ani4.ASE");
	sField[cnt].SetCenterPos(-88012, -3886);
	sField[cnt].AddStartPoint(-88012, -3886);
