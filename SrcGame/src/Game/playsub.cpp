...
static short	AgingBlinkColor[CONST_AGINGBCOLOR_MAX][6] =
{
	...
	{ 255,	162,	0,		0,	 5,	smTEXSTATE_FS_SCROLL10}, //41
	{ 1024, 256, 256, 0, 2, smTEXSTATE_FS_SCROLL10 }, //42
	{ 256, 256, 640, 0, 2, smTEXSTATE_FS_SCROLL10 }, //43
	{ 130,	  0,	255,	0,	 5,	smTEXSTATE_FS_SCROLL10	},//44
	{ 220,	240,	 70,	0,	 5,	smTEXSTATE_FS_SCROLL10	},//45
	{ 240,	240,	240,	0,	 5,	smTEXSTATE_FS_SCROLL10	},//46
	{   0,	207,	255,	0,	 5,	smTEXSTATE_FS_SCROLL10},// 47
	{ 155,	0,		30,		0,	 2,	smTEXSTATE_FS_REFLEX},// 48
	{ 255,	0,		30,		150, 4,	smTEXSTATE_FS_REFLEX},// 49
	{ 255,	0,		30,		100, 4,	smTEXSTATE_FS_REFLEX},// 50
	{ 255,	0,		30,		0,	 4,	smTEXSTATE_FS_REFLEX}, //51
	{ 255,	162,	0,		0,	 5,	smTEXSTATE_FS_SCROLL10}, //52
	{   0,	207,	255,	0,	 5,	smTEXSTATE_FS_SCROLL10},// 53
	{ 155,	0,		30,		0,	 2,	smTEXSTATE_FS_REFLEX},// 54
	{ 255,	0,		30,		150, 4,	smTEXSTATE_FS_REFLEX},// 55
	{ 255,	0,		30,		100, 4,	smTEXSTATE_FS_REFLEX},// 56
	{ 255,	0,		30,		0,	 4,	smTEXSTATE_FS_REFLEX}, //57
	{ 255,	162,	0,		0,	 5,	smTEXSTATE_FS_SCROLL10}, //58
	{ 255,	0,		30,		0,	 4,	smTEXSTATE_FS_REFLEX}, //59
	{ 255,	162,	0,		0,	 5,	smTEXSTATE_FS_SCROLL10}, //60
};
...
int GetDeathPenalty()
{
	...
	// Não cobra ressu sendo vip e não perde experiência
...
int QuitGame()
{
	...
	if (cWareHouse.OpenFlag || cCraftItem.OpenFlag || cTrade.OpenFlag || cAging.OpenFlag || SmeltingItem.OpenFlag || ManufactureItem.m_OpenFlag || cMixtureReset.OpenFlag || Caravana::GetInstance()->OpenFlag || CRAFTWINDOW->isOpen() || CRAFTGOLDWINDOW->isOpen())
	{
...
{
	if (cSkinChanger.isOpen()) return FALSE;
