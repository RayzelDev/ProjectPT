...
int VIP::vipCommands() {
	...
	case 3:
		...
		CHATGAMEHANDLE->AddChatBoxText("Aviso: Você ganha 2% de atq!", EChatColor::CHATCOLOR_Error);


		CHATGAMEHANDLE->AddChatBoxText("Ressu infinito(PVE)", EChatColor::CHATCOLOR_Error);
		//CHATGAMEHANDLE->AddChatBoxText("/MapaVip", EChatColor::CHATCOLOR_Error);
		CHATGAMEHANDLE->AddChatBoxText("/bc", EChatColor::CHATCOLOR_Error);
		CHATGAMEHANDLE->AddChatBoxText("/pillai", EChatColor::CHATCOLOR_Error);
		CHATGAMEHANDLE->AddChatBoxText("/ric", EChatColor::CHATCOLOR_Error);
		break;
	}
