...
class UINewHorizontalScroll : public NewElement
{
public:
	UINewHorizontalScroll(int iID, int x, int y, int minValue, int maxValue, int startValue = -1);
...
private:
	UINewImage* ScrollBar;
	UINewImage* ScrollBarBg;
	UINewImage* ScrollButton;
