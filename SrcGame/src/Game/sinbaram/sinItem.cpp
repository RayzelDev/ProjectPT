...
sITEM sItem[MAX_ITEM] = {
	...
	{ sinWA1 | sin39, "Axe", "WA139", ITEMSIZE * 2, ITEMSIZE * 4, "Weapon", ITEM_CLASS_WEAPON_TWO, "WA139", INVENTORY_POS_RHAND, SIN_SOUND_AXES, ITEM_WEAPONCLASS_NOT_SHOOTING },
	...
	{ sinWS1 | sin31, "CrossBow", "WS131", ITEMSIZE * 2, ITEMSIZE * 4, "Weapon", ITEM_CLASS_WEAPON_TWO, "WS131", INVENTORY_POS_LHAND, SIN_SOUND_SHOOTERS, ITEM_WEAPONCLASS_SHOOTING },
	...
	// Derivados
	{ sinBI2 | sin53, "Barra de Bronze", "BI251", ITEMSIZE * 1, ITEMSIZE * 1, "Premium", ITEM_CLASS_ECORE, "BI251", 0, SIN_SOUND_SHELTOM },
	...
	{ sinBI2 | sin88, "Box Donate",			 "BI294", ITEMSIZE * 2, ITEMSIZE * 2, "Premium", ITEM_CLASS_ECORE, "BI294", 0, SIN_SOUND_SHELTOM },
	{ sinBI2 | sin89, "Box Mix",			 "BI295", ITEMSIZE * 1, ITEMSIZE * 1, "Premium", ITEM_CLASS_ECORE, "BI295", 0, SIN_SOUND_SHELTOM },
	{ sinBI2 | sin90, "Vale Level",			 "BI296", ITEMSIZE * 1, ITEMSIZE * 1, "Premium", ITEM_CLASS_ECORE, "BI296", 0, SIN_SOUND_SHELTOM },
	{ sinBI2 | sin91, "Vale Level",			 "BI297", ITEMSIZE * 2, ITEMSIZE * 2, "Premium", ITEM_CLASS_ECORE, "BI297", 0, SIN_SOUND_SHELTOM },
	...
	{ sinBI2 | sin67, "cx 1", "BI267", ITEMSIZE * 2, ITEMSIZE * 2, "Premium", ITEM_CLASS_ECORE, "BI267", 0, SIN_SOUND_POTION },
	{ sinBI2 | sin68, "cx 2", "BI268", ITEMSIZE * 2, ITEMSIZE * 2, "Premium", ITEM_CLASS_ECORE, "BI268", 0, SIN_SOUND_POTION },
	{ sinBI2 | sin79, "cx 3", "BI269", ITEMSIZE * 2, ITEMSIZE * 2, "Premium", ITEM_CLASS_ECORE, "BI269", 0, SIN_SOUND_POTION },
	{ sinBI2 | sin70, "cx 4", "BI270", ITEMSIZE * 2, ITEMSIZE * 2, "Premium", ITEM_CLASS_ECORE, "BI270", 0, SIN_SOUND_POTION },
	{ sinBI2 | sin71, "cx 5", "BI271", ITEMSIZE * 2, ITEMSIZE * 2, "Premium", ITEM_CLASS_ECORE, "BI271", 0, SIN_SOUND_POTION },
	{ sinBI2 | sin72, "cx 6", "BI272", ITEMSIZE * 2, ITEMSIZE * 2, "Premium", ITEM_CLASS_ECORE, "BI272", 0, SIN_SOUND_POTION },
	{ sinBI2 | sin73, "cx 7", "BI273", ITEMSIZE * 2, ITEMSIZE * 2, "Premium", ITEM_CLASS_ECORE, "BI273", 0, SIN_SOUND_POTION },
	{ sinBI2 | sin74, "cx 8", "BI274", ITEMSIZE * 2, ITEMSIZE * 2, "Premium", ITEM_CLASS_ECORE, "BI274", 0, SIN_SOUND_POTION },
	{ sinBI2 | sin75, "cx 9", "BI275", ITEMSIZE * 2, ITEMSIZE * 2, "Premium", ITEM_CLASS_ECORE, "BI275", 0, SIN_SOUND_POTION },
	{ sinBI2 | sin76, "cx 10", "BI276", ITEMSIZE * 2, ITEMSIZE * 2, "Premium", ITEM_CLASS_ECORE, "BI276", 0, SIN_SOUND_POTION },
	{ sinBI2 | sin77, "cx 11", "BI277", ITEMSIZE * 2, ITEMSIZE * 2, "Premium", ITEM_CLASS_ECORE, "BI277", 0, SIN_SOUND_POTION },
	{ sinBI2 | sin78, "cx 12", "BI278", ITEMSIZE * 1, ITEMSIZE * 1, "Premium", ITEM_CLASS_ECORE, "BI278", 0, SIN_SOUND_POTION },
	{ sinBI2 | sin79, "cx 13", "BI279", ITEMSIZE * 2, ITEMSIZE * 2, "Premium", ITEM_CLASS_ECORE, "BI279", 0, SIN_SOUND_POTION },
	{ sinBI2 | sin80, "cx 14", "BI280", ITEMSIZE * 2, ITEMSIZE * 2, "Premium", ITEM_CLASS_ECORE, "BI280", 0, SIN_SOUND_POTION },
	{ sinBI2 | sin81, "cx 15", "BI281", ITEMSIZE * 2, ITEMSIZE * 2, "Premium", ITEM_CLASS_ECORE, "BI281", 0, SIN_SOUND_POTION },
	...
	{sinGG1 | sin02  ,"Exp"   ,"GG102",  ITEMSIZE * 1, ITEMSIZE * 1,"Exp" ,  0   ,"DRExp" , 0  ,SIN_SOUND_MAGICIAL},
		...
		//SKINS ITENS ZERUS
	{ sinSK1 | sin01 ,"Skin Stone" ,"SK101",ITEMSIZE * 3,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK101",0,SIN_SOUND_SHELTOM },
	{ sinSK1 | sin02 ,"Skin Stone" ,"SK102",ITEMSIZE * 3,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK102",0,SIN_SOUND_SHELTOM },
	{ sinSK1 | sin03 ,"Skin Stone" ,"SK103",ITEMSIZE * 3,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK103",0,SIN_SOUND_SHELTOM },
	{ sinSK1 | sin04 ,"Skin Stone" ,"SK104",ITEMSIZE * 3,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK104",0,SIN_SOUND_SHELTOM },
	{ sinSK1 | sin05 ,"Skin Stone" ,"SK105",ITEMSIZE * 3,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK105",0,SIN_SOUND_SHELTOM },
	{ sinSK1 | sin06 ,"Skin Stone" ,"SK106",ITEMSIZE * 3,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK106",0,SIN_SOUND_SHELTOM },
	{ sinSK1 | sin07 ,"Skin Stone" ,"SK107",ITEMSIZE * 3,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK107",0,SIN_SOUND_SHELTOM },
	{ sinSK1 | sin08 ,"Skin Stone" ,"SK108",ITEMSIZE * 3,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK108",0,SIN_SOUND_SHELTOM },
	{ sinSK1 | sin09 ,"Skin Stone" ,"SK109",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK109",0,SIN_SOUND_SHELTOM },
	{ sinSK1 | sin10 ,"Skin Stone" ,"SK110",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK110",0,SIN_SOUND_SHELTOM },
	{ sinSK1 | sin11 ,"Skin Stone" ,"SK111",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK111",0,SIN_SOUND_SHELTOM },
	{ sinSK1 | sin12 ,"Skin Stone" ,"SK112",ITEMSIZE * 2,ITEMSIZE * 3,"skins",ITEM_CLASS_ECORE,"SK112",0,SIN_SOUND_SHELTOM },
	{ sinSK1 | sin13 ,"Skin Stone" ,"SK113",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK113",0,SIN_SOUND_SHELTOM },
	{ sinSK1 | sin14 ,"Skin Stone" ,"SK114",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK114",0,SIN_SOUND_SHELTOM },
	{ sinSK1 | sin15 ,"Skin Stone" ,"SK115",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK115",0,SIN_SOUND_SHELTOM },
	{ sinSK1 | sin16 ,"Skin Stone" ,"SK116",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK116",0,SIN_SOUND_SHELTOM },
	{ sinSK1 | sin17 ,"Skin Stone" ,"SK117",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK117",0,SIN_SOUND_SHELTOM },
	{ sinSK1 | sin18 ,"Skin Stone" ,"SK118",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK118",0,SIN_SOUND_SHELTOM },
	{ sinSK1 | sin19 ,"Skin Stone" ,"SK119",ITEMSIZE * 1,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK119",0,SIN_SOUND_SHELTOM },
	{ sinSK1 | sin20 ,"Skin Stone" ,"SK120",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK120",0,SIN_SOUND_SHELTOM },
	{ sinSK1 | sin21 ,"Skin Stone" ,"SK121",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK121",0,SIN_SOUND_SHELTOM },
	{ sinSK1 | sin22 ,"Skin Stone" ,"SK122",ITEMSIZE * 2,ITEMSIZE * 3,"skins",ITEM_CLASS_ECORE,"SK122",0,SIN_SOUND_SHELTOM },
	{ sinSK1 | sin23 ,"Skin Stone" ,"SK123",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK123",0,SIN_SOUND_SHELTOM },
	{ sinSK1 | sin24 ,"Skin Stone" ,"SK124",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK124",0,SIN_SOUND_SHELTOM },
	{ sinSK1 | sin25 ,"Skin Stone" ,"SK125",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK125",0,SIN_SOUND_SHELTOM },
	{ sinSK1 | sin26 ,"Skin Stone" ,"SK126",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK126",0,SIN_SOUND_SHELTOM },
	{ sinSK1 | sin27 ,"Skin Stone" ,"SK127",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK127",0,SIN_SOUND_SHELTOM },
	{ sinSK1 | sin28 ,"Skin Stone" ,"SK128",ITEMSIZE * 1,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK128",0,SIN_SOUND_SHELTOM },
	{ sinSK1 | sin29 ,"Skin Stone" ,"SK129",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK129",0,SIN_SOUND_SHELTOM },
	{ sinSK1 | sin30 ,"Skin Stone" ,"SK130",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK130",0,SIN_SOUND_SHELTOM },
	{ sinSK1 | sin31 ,"Skin Stone" ,"SK131",ITEMSIZE * 2,ITEMSIZE * 3,"skins",ITEM_CLASS_ECORE,"SK131",0,SIN_SOUND_SHELTOM },
	{ sinSK1 | sin32 ,"Skin Stone" ,"SK132",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK132",0,SIN_SOUND_SHELTOM },
	{ sinSK1 | sin33 ,"Skin Stone" ,"SK133",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK133",0,SIN_SOUND_SHELTOM },
	{ sinSK1 | sin34 ,"Skin Stone" ,"SK134",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK134",0,SIN_SOUND_SHELTOM },
	{ sinSK1 | sin35 ,"Skin Stone" ,"SK135",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK135",0,SIN_SOUND_SHELTOM },
	{ sinSK1 | sin36 ,"Skin Stone" ,"SK136",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK136",0,SIN_SOUND_SHELTOM },
	{ sinSK1 | sin37 ,"Skin Stone" ,"SK137",ITEMSIZE * 1,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK137",0,SIN_SOUND_SHELTOM },
	{ sinSK1 | sin38 ,"Skin Stone" ,"SK138",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK138",0,SIN_SOUND_SHELTOM },
	{ sinSK1 | sin39 ,"Skin Stone" ,"SK139",ITEMSIZE * 2,ITEMSIZE * 3,"skins",ITEM_CLASS_ECORE,"SK139",0,SIN_SOUND_SHELTOM },
	{ sinSK1 | sin40 ,"Skin Stone" ,"SK140",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK140",0,SIN_SOUND_SHELTOM },
	{ sinSK1 | sin41 ,"Skin Stone" ,"SK141",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK141",0,SIN_SOUND_SHELTOM },
	{ sinSK1 | sin42 ,"Skin Stone" ,"SK142",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK142",0,SIN_SOUND_SHELTOM },
	{ sinSK1 | sin43 ,"Skin Stone" ,"SK143",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK143",0,SIN_SOUND_SHELTOM },
	{ sinSK1 | sin44 ,"Skin Stone" ,"SK144",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK144",0,SIN_SOUND_SHELTOM },
	{ sinSK1 | sin45 ,"Skin Stone" ,"SK145",ITEMSIZE * 1,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK145",0,SIN_SOUND_SHELTOM },
	{ sinSK1 | sin46 ,"Skin Stone" ,"SK146",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK146",0,SIN_SOUND_SHELTOM },
	{ sinSK1 | sin47 ,"Skin Stone" ,"SK147",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK147",0,SIN_SOUND_SHELTOM },
	{ sinSK1 | sin48 ,"Skin Stone" ,"SK148",ITEMSIZE * 2,ITEMSIZE * 3,"skins",ITEM_CLASS_ECORE,"SK148",0,SIN_SOUND_SHELTOM },
	{ sinSK1 | sin49 ,"Skin Stone" ,"SK149",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK149",0,SIN_SOUND_SHELTOM },
	{ sinSK1 | sin50 ,"Skin Stone" ,"SK150",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK150",0,SIN_SOUND_SHELTOM },
	{ sinSK1 | sin51 ,"Skin Stone" ,"SK151",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK151",0,SIN_SOUND_SHELTOM },
	{ sinSK1 | sin52 ,"Skin Stone" ,"SK152",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK152",0,SIN_SOUND_SHELTOM },
	{ sinSK1 | sin53 ,"Skin Stone" ,"SK153",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK153",0,SIN_SOUND_SHELTOM },
	{ sinSK1 | sin54 ,"Skin Stone" ,"SK154",ITEMSIZE * 1,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK154",0,SIN_SOUND_SHELTOM },
	{ sinSK1 | sin55 ,"Skin Stone" ,"SK155",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK155",0,SIN_SOUND_SHELTOM },
	{ sinSK1 | sin56 ,"Skin Stone" ,"SK156",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK156",0,SIN_SOUND_SHELTOM },
	{ sinSK1 | sin57 ,"Skin Stone" ,"SK157",ITEMSIZE * 2,ITEMSIZE * 3,"skins",ITEM_CLASS_ECORE,"SK157",0,SIN_SOUND_SHELTOM },
	{ sinSK1 | sin58 ,"Skin Stone" ,"SK159",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK158",0,SIN_SOUND_SHELTOM },
	{ sinSK1 | sin59 ,"Skin Stone" ,"SK159",ITEMSIZE * 2,ITEMSIZE * 3,"skins",ITEM_CLASS_ECORE,"SK159",0,SIN_SOUND_SHELTOM },
	{ sinSK1 | sin60 ,"Skin Stone" ,"SK160",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK160",0,SIN_SOUND_SHELTOM },
	{ sinSK1 | sin61 ,"Skin Stone" ,"SK161",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK161",0,SIN_SOUND_SHELTOM },
	{ sinSK1 | sin62 ,"Skin Stone" ,"SK162",ITEMSIZE * 2,ITEMSIZE * 3,"skins",ITEM_CLASS_ECORE,"SK162",0,SIN_SOUND_SHELTOM },
	{ sinSK1 | sin63 ,"Skin Stone" ,"SK163",ITEMSIZE * 1,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK163",0,SIN_SOUND_SHELTOM },
	{ sinSK1 | sin64 ,"Skin Stone" ,"SK164",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK164",0,SIN_SOUND_SHELTOM },
	{ sinSK1 | sin65 ,"Skin Stone" ,"SK165",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK165",0,SIN_SOUND_SHELTOM },
	{ sinSK1 | sin66 ,"Skin Stone" ,"SK166",ITEMSIZE * 2,ITEMSIZE * 3,"skins",ITEM_CLASS_ECORE,"SK166",0,SIN_SOUND_SHELTOM },
	{ sinSK1 | sin67 ,"Skin Stone" ,"SK167",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK167",0,SIN_SOUND_SHELTOM },
	{ sinSK1 | sin68 ,"Skin Stone" ,"SK168",ITEMSIZE * 2,ITEMSIZE * 2,"skins",ITEM_CLASS_ECORE,"SK168",0,SIN_SOUND_SHELTOM },
	{ sinSK1 | sin69 ,"Skin Stone" ,"SK169",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK169",0,SIN_SOUND_SHELTOM },
	{ sinSK1 | sin70 ,"Skin Stone" ,"SK170",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK170",0,SIN_SOUND_SHELTOM },
	{ sinSK1 | sin71 ,"Skin Stone" ,"SK171",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK171",0,SIN_SOUND_SHELTOM },
	{ sinSK1 | sin72 ,"Skin Stone" ,"SK172",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK172",0,SIN_SOUND_SHELTOM },
	{ sinSK1 | sin73 ,"Skin Stone" ,"SK173",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK173",0,SIN_SOUND_SHELTOM },
	{ sinSK1 | sin74 ,"Skin Stone" ,"SK174",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK174",0,SIN_SOUND_SHELTOM },
	{ sinSK1 | sin75 ,"Skin Stone" ,"SK175",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK175",0,SIN_SOUND_SHELTOM },
	{ sinSK1 | sin76 ,"Skin Stone" ,"SK176",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK176",0,SIN_SOUND_SHELTOM },
	{ sinSK1 | sin77 ,"Skin Stone" ,"SK177",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK177",0,SIN_SOUND_SHELTOM },
	{ sinSK1 | sin78 ,"Skin Stone" ,"SK178",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK178",0,SIN_SOUND_SHELTOM },
	{ sinSK1 | sin79 ,"Skin Stone" ,"SK179",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK179",0,SIN_SOUND_SHELTOM },
	{ sinSK1 | sin80 ,"Skin Stone" ,"SK180",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK180",0,SIN_SOUND_SHELTOM },
	{ sinSK1 | sin81 ,"Skin Stone" ,"SK181",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK181",0,SIN_SOUND_SHELTOM },
	{ sinSK1 | sin82 ,"Skin Stone" ,"SK182",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK182",0,SIN_SOUND_SHELTOM },
	{ sinSK1 | sin83 ,"Skin Stone" ,"SK183",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK183",0,SIN_SOUND_SHELTOM },
	{ sinSK1 | sin84 ,"Skin Stone" ,"SK184",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK184",0,SIN_SOUND_SHELTOM },
	{ sinSK1 | sin85 ,"Skin Stone" ,"SK185",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK185",0,SIN_SOUND_SHELTOM },
	{ sinSK1 | sin86 ,"Skin Stone" ,"SK186",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK186",0,SIN_SOUND_SHELTOM },
	{ sinSK1 | sin87 ,"Skin Stone" ,"SK187",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK187",0,SIN_SOUND_SHELTOM },
	{ sinSK1 | sin88 ,"Skin Stone" ,"SK188",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK188",0,SIN_SOUND_SHELTOM },
	{ sinSK1 | sin89 ,"Skin Stone" ,"SK189",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK189",0,SIN_SOUND_SHELTOM },
	{ sinSK1 | sin90 ,"Skin Stone" ,"SK190",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK190",0,SIN_SOUND_SHELTOM },
	{ sinSK1 | sin91 ,"Skin Stone" ,"SK191",ITEMSIZE * 1,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK191",0,SIN_SOUND_SHELTOM },
	{ sinSK1 | sin92 ,"Skin Stone" ,"SK192",ITEMSIZE * 1,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK192",0,SIN_SOUND_SHELTOM },
	{ sinSK1 | sin93 ,"Skin Stone" ,"SK193",ITEMSIZE * 1,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK193",0,SIN_SOUND_SHELTOM },
	{ sinSK1 | sin94 ,"Skin Stone" ,"SK194",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK194",0,SIN_SOUND_SHELTOM },
	{ sinSK1 | sin95 ,"Skin Stone" ,"SK195",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK195",0,SIN_SOUND_SHELTOM },
	{ sinSK1 | sin96 ,"Skin Stone" ,"SK196",ITEMSIZE * 3,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK196",0,SIN_SOUND_SHELTOM },
	{ sinSK1 | sin97 ,"Skin Stone" ,"SK197",ITEMSIZE * 3,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK197",0,SIN_SOUND_SHELTOM },
	{ sinSK1 | sin98 ,"Skin Stone" ,"SK198",ITEMSIZE * 3,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK198",0,SIN_SOUND_SHELTOM },
	{ sinSK2 | sin01 ,"Skin Stone" ,"SK201",ITEMSIZE * 3,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK201",0,SIN_SOUND_SHELTOM },
	{ sinSK2 | sin02 ,"Skin Stone" ,"SK202",ITEMSIZE * 3,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK202",0,SIN_SOUND_SHELTOM },
	{ sinSK2 | sin03 ,"Skin Stone" ,"SK203",ITEMSIZE * 3,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK203",0,SIN_SOUND_SHELTOM },
	{ sinSK2 | sin04 ,"Skin Stone" ,"SK204",ITEMSIZE * 3,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK204",0,SIN_SOUND_SHELTOM },
	{ sinSK2 | sin05 ,"Skin Stone" ,"SK205",ITEMSIZE * 3,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK205",0,SIN_SOUND_SHELTOM },

	//Skins de Foice by Daniel
	{ sinSK2 | sin10 ,"Skin de Foice" ,"SK210",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK210",0,SIN_SOUND_SHELTOM },
	{ sinSK2 | sin11 ,"Skin de Foice" ,"SK211",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK211",0,SIN_SOUND_SHELTOM },
	{ sinSK2 | sin12 ,"Skin de Foice" ,"SK212",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK212",0,SIN_SOUND_SHELTOM },
	{ sinSK2 | sin13 ,"Skin de Foice" ,"SK213",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK213",0,SIN_SOUND_SHELTOM },
	{ sinSK2 | sin14 ,"Skin de Foice" ,"SK214",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK214",0,SIN_SOUND_SHELTOM },
	{ sinSK2 | sin15 ,"Skin de Foice" ,"SK215",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK215",0,SIN_SOUND_SHELTOM },
	{ sinSK2 | sin16 ,"Skin de Foice" ,"SK216",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK216",0,SIN_SOUND_SHELTOM },
	{ sinSK2 | sin17 ,"Skin de Foice" ,"SK217",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK217",0,SIN_SOUND_SHELTOM },
	{ sinSK2 | sin18 ,"Skin de Foice" ,"SK218",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK218",0,SIN_SOUND_SHELTOM },

	//Skins de Machado by Daniel
	{ sinSK2 | sin20 ,"Skin de Machado" ,"SK220",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK220",0,SIN_SOUND_SHELTOM },
	{ sinSK2 | sin21 ,"Skin de Machado" ,"SK221",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK221",0,SIN_SOUND_SHELTOM },
	{ sinSK2 | sin22 ,"Skin de Machado" ,"SK222",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK222",0,SIN_SOUND_SHELTOM },
	{ sinSK2 | sin23 ,"Skin de Machado" ,"SK223",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK223",0,SIN_SOUND_SHELTOM },
	{ sinSK2 | sin24 ,"Skin de Machado" ,"SK224",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK224",0,SIN_SOUND_SHELTOM },
	{ sinSK2 | sin25 ,"Skin de Machado" ,"SK225",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK225",0,SIN_SOUND_SHELTOM },
	{ sinSK2 | sin26 ,"Skin de Machado" ,"SK226",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK226",0,SIN_SOUND_SHELTOM },


	//Skins de Garras by Daniel
	{ sinSK2 | sin30 ,"Skin de Garra" ,"SK230",ITEMSIZE * 2,ITEMSIZE * 3,"skins",ITEM_CLASS_ECORE,"SK230",0,SIN_SOUND_SHELTOM },
	{ sinSK2 | sin31 ,"Skin de Garra" ,"SK231",ITEMSIZE * 2,ITEMSIZE * 3,"skins",ITEM_CLASS_ECORE,"SK231",0,SIN_SOUND_SHELTOM },
	{ sinSK2 | sin32 ,"Skin de Garra" ,"SK232",ITEMSIZE * 2,ITEMSIZE * 3,"skins",ITEM_CLASS_ECORE,"SK232",0,SIN_SOUND_SHELTOM },
	{ sinSK2 | sin33 ,"Skin de Garra" ,"SK233",ITEMSIZE * 2,ITEMSIZE * 3,"skins",ITEM_CLASS_ECORE,"SK233",0,SIN_SOUND_SHELTOM },
	{ sinSK2 | sin34 ,"Skin de Garra" ,"SK234",ITEMSIZE * 2,ITEMSIZE * 3,"skins",ITEM_CLASS_ECORE,"SK234",0,SIN_SOUND_SHELTOM },
	{ sinSK2 | sin35 ,"Skin de Garra" ,"SK235",ITEMSIZE * 2,ITEMSIZE * 3,"skins",ITEM_CLASS_ECORE,"SK235",0,SIN_SOUND_SHELTOM },

	//Skins de Arcos by Daniel
	{ sinSK2 | sin40 ,"Skin de Arco" ,"SK240",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK240",0,SIN_SOUND_SHELTOM },
	{ sinSK2 | sin41 ,"Skin de Arco" ,"SK241",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK241",0,SIN_SOUND_SHELTOM },
	{ sinSK2 | sin42 ,"Skin de Arco" ,"SK242",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK242",0,SIN_SOUND_SHELTOM },
	{ sinSK2 | sin43 ,"Skin de Arco" ,"SK243",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK243",0,SIN_SOUND_SHELTOM },
	{ sinSK2 | sin44 ,"Skin de Arco" ,"SK244",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK244",0,SIN_SOUND_SHELTOM },
	{ sinSK2 | sin45 ,"Skin de Arco" ,"SK245",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK245",0,SIN_SOUND_SHELTOM },

	//Skins de Espada by Daniel
	{ sinSK2 | sin50 ,"Skin de Espada" ,"SK250",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK250",0,SIN_SOUND_SHELTOM },
	{ sinSK2 | sin51 ,"Skin de Espada" ,"SK251",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK251",0,SIN_SOUND_SHELTOM },
	{ sinSK2 | sin52 ,"Skin de Espada" ,"SK252",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK252",0,SIN_SOUND_SHELTOM },
	{ sinSK2 | sin53 ,"Skin de Espada" ,"SK253",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK253",0,SIN_SOUND_SHELTOM },

	//Skins de Lança by Daniel
	{ sinSK2 | sin60 ,"Skin de Lança" ,"SK260",ITEMSIZE * 1,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK260",0,SIN_SOUND_SHELTOM },
	{ sinSK2 | sin61 ,"Skin de Lança" ,"SK261",ITEMSIZE * 1,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK261",0,SIN_SOUND_SHELTOM },
	{ sinSK2 | sin62 ,"Skin de Lança" ,"SK262",ITEMSIZE * 1,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK262",0,SIN_SOUND_SHELTOM },
	{ sinSK2 | sin63 ,"Skin de Lança" ,"SK263",ITEMSIZE * 1,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK263",0,SIN_SOUND_SHELTOM },
	{ sinSK2 | sin64 ,"Skin de Lança" ,"SK264",ITEMSIZE * 1,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK264",0,SIN_SOUND_SHELTOM },
	{ sinSK2 | sin65 ,"Skin de Lança" ,"SK265",ITEMSIZE * 1,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK265",0,SIN_SOUND_SHELTOM },

	//Skins de Escudo by Daniel
	{ sinSK2 | sin70 ,"Skin de Escudo" ,"SK270",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK270",0,SIN_SOUND_SHELTOM },
	{ sinSK2 | sin71 ,"Skin de Escudo" ,"SK271",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK271",0,SIN_SOUND_SHELTOM },
	{ sinSK2 | sin72 ,"Skin de Escudo" ,"SK272",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK272",0,SIN_SOUND_SHELTOM },
	{ sinSK2 | sin73 ,"Skin de Escudo" ,"SK273",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK273",0,SIN_SOUND_SHELTOM },
	{ sinSK2 | sin74 ,"Skin de Escudo" ,"SK274",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK274",0,SIN_SOUND_SHELTOM },
	{ sinSK2 | sin75 ,"Skin de Escudo" ,"SK275",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK275",0,SIN_SOUND_SHELTOM },
	{ sinSK2 | sin76 ,"Skin de Escudo" ,"SK276",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK276",0,SIN_SOUND_SHELTOM },
	{ sinSK2 | sin77 ,"Skin de Escudo" ,"SK277",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK277",0,SIN_SOUND_SHELTOM },
	{ sinSK2 | sin78 ,"Skin de Escudo" ,"SK278",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK278",0,SIN_SOUND_SHELTOM }, 

	//Skins de Armaduras by Daniel
	{ sinSK2 | sin80 ,"Skin de Armadura" ,"SK280",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK280",0,SIN_SOUND_SHELTOM },
	{ sinSK2 | sin81 ,"Skin de Armadura" ,"SK281",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK281",0,SIN_SOUND_SHELTOM },
	{ sinSK2 | sin82 ,"Skin de Armadura" ,"SK282",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK282",0,SIN_SOUND_SHELTOM },
	{ sinSK2 | sin83 ,"Skin de Armadura" ,"SK283",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK283",0,SIN_SOUND_SHELTOM },
	{ sinSK2 | sin84 ,"Skin de Armadura" ,"SK284",ITEMSIZE * 2,ITEMSIZE * 4,"skins",ITEM_CLASS_ECORE,"SK284",0,SIN_SOUND_SHELTOM },
