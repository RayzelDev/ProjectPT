...
char* SheltomName[MAX_SHELTOM] = { "Lucidy", "Fadeo", "Sparki", "Raident", "Transparo", "Murki", "Devine", "Celesto", "Miraje", "πInferna", "Enigma", "Bellum", "Ordo", "Sapphire" };
...
//Falha do aging
int AgingOkPercent[20] = { 0, 0, 0, 0, 0, 0, 0, 0, 0, 11, 18, 28, 36, 44, 52, 58, 67, 75, 82, 88 };
...
int cAGING::SetAgingItemAreaCheck(sITEM * pItem)
{
	...
	if (pItem->sItemInfo.CODE == (sinBI1 | sin10) || pItem->sItemInfo.CODE == (sinBI1 | sin11) ||
		...
		pItem->sItemInfo.CODE == (sinBI1 | sin85) || pItem->sItemInfo.CODE == (sinBI2 | sin38) || pItem->sItemInfo.CODE == (sinBI2 | sin52)) // ¿Â∫∞ - Ω¥∆€ ø°¿Ã¬° Ω∫≈Ê 1.5
	{
		cAging.AginStoneKind = 0;
		int AgingStoneX = 159 + 11, AgingStoneY = 268 + 11 + sinInterHeight2;
		TradeColorIndex = 0; //√ ±‚»≠   (∆Æ∑π¿ÃµÂ √¢∞˙ √¢∞Ì∞° ∞∞¿Ã æ¥¥Ÿ)
