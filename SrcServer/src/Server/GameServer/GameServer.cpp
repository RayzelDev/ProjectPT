			...
			if (db->Execute(false))
			{
				while (db->NextRow())
				{
					...
					case 33: // Novo npc de Skins
						...
						break;
					case 34: // Novo npc de Skins
						Npc->smMonsterInfo.NpcCraftGold = TRUE;
						break;
					case 35: // Novo npc de Skins
						Npc->smMonsterInfo.NpcCraftCoin = TRUE;
						break;
					case 36: // Novo npc de Skins
						Npc->smMonsterInfo.NpcReview = TRUE;
						break;
